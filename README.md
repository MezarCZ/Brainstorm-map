...
<head>
    <meta charset="UTF-8">
    <title>Brainstorming Neon - DoubleClick Edit</title>
    <style>
        body { 
...
<body>
    ...
    <script>
        ...
        txt('saveBtn', "Ulo\u017Eit");
        txt('loadBtn', "Otev\u0159\u00EDt");
        txt('hint-box', "Klik a t\u00E1hni: Pohyb | Dvojklik: Psan\u00ED | Prav\u00E9 tl.: Smazat");
        ...
        function createBubbleElement(x, y, color) {
            ...
            el.className = 'bubble';
            el.contentEditable = "false"; // Defaultně nelze psát
            updateBubbleStyle(el, color);

            // Paleta pro změnu barvy
            ...
            el.onmousedown = (e) => {
                if (el.contentEditable === "true") return; // Pokud píšeme, nehýbeme
        ...
        function saveToLocalStorage() {
            ...
            localStorage.setItem('myNeonHybridV4', JSON.stringify(data));
        }

        function exportToFile() { saveToLocalStorage(); const data = localStorage.getItem('myNeonHybridV4'); const blob = new Blob([data], { type: 'application/json' }); const url = URL.createObjectURL(blob); const a = document.createElement('a'); a.href = url; a.download = 'projekt.json'; a.click(); }
        ...
        window.onload = () => { const saved = localStorage.getItem('myNeonHybridV4'); if (saved) loadFromData(JSON.parse(saved)); applyPhysics(); };
    </script>
</body>
</html><!DOCTYPE html>
<html lang="cs">
